                ...
                {ordersData.map((order) => (
                    ...
                    className="bg-white p-5 rounded-md mb-2 overflow-hidden">
                        <div className="flex items-start gap-10">
                            <img src={order.poster} alt={order.title} className="w-30 h-40 object-cover rounded" />
                            {/* Divider with fixed height same as image height */}
                        ...
                        <div className="p-4 text-right">
                            <p className="text-sm text-gray-500">Text: ${order.ticket.toFixed(2)}</p>
                        </div>
                    </div>
