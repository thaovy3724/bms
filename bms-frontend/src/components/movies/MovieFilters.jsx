...
const MovieFilters = () => {
    return (
        <div className="w-full md:w-1/4 p-4 space-y-5">
                ...
                <div className="flex flex-wrap gap-2">
                    {
                        languages.map((language, index) => (
                            <span key = {index} className="border border-gray-200 text-[#f74362] 
            ...
            <button className="w-full border cursor-pointer border-[#f74362] 
            text-[#f74362] hover:bg-[#f74362] hover:text-white py-1 rounded">
                Browse by Cinemas
            </button>
        </div>
    );
