...
import { theaters } from '../../utils/constants';
                    ...
                    next7Days.map((date, index) => {
                        ...
                        return (
                            ...
                            className={`flex cursor-pointer flex-col border border-gray-200 items-center 
                                px-3 py-2 rounded-lg min-w-[50px] ${
                    ...
                    theaters.map((theater, index) => (
                        <div key={index}>
                            ...
                            <div className="flex flex-wrap gap-3 ml-11">
                                {
                                    theater.timings.map((slot, index) => (
                                        <button key={index} 
                                        className="border cursor-pointer hover:bg-gray-100 border-gray-300 
                                        rounded-[16px] px-12 py-2 text-sm flex flex-col items-center justify-center">
