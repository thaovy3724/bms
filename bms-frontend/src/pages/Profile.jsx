                ...
                <div className="max-w-6xl mx-auto">
                    {/* Profile Section */}
                    {
                        activeTab === "Profile" && (
                            <>
                                {/* Headers */}
                                <div className="bg-gradient-to-r from-gray-800 to-[#f74565] 
                                rounded-t-md px-6 flex items-center gap-6 text-white">
                                    <div className="relative w-20 h-20 border-4 border-white rounded-full flex items-center justify-center bg-white text-gray-60">
                                        <IoMdAdd size={24}/>
                                    </div>
                                    <div className="mt-2">
                                        <h2 className="text-2xl font-bold">Hi, Armit Raj</h2>
                                ...
                                <div className="bg-white p-6 mt-4 rounded-md">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <input type="text" defaultValue="Armit Raj" className="w-full mt-1 border border-gray-200 rounded-lg px-3 py-2" />
                                        </div>
                                        <div>
